...
function App() {
  ...
  else if (screen === '7_completeReport') content = <CompleteReport error={error} isLoading={busy === 'share'} onShare={handleShare} report={report} onBack={() => setScreen('mainBoard')} shareCard={shareCard} />
